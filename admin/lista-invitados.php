          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Administración lista de invitados</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                    ...
                    <?php 
                        try {
                         ...
                         while($invitado = $resultado->fetch_assoc()){?>
                             ...
                             <tr>
                               <td><?php echo $invitado['nombre'] ." ". $invitado['apellido'] ;  ?></td>
                               <td><?php echo $invitado['descripcion'];  ?></td>                               
                               <td><img src="../img/invitados/<?php echo $invitado['url_imagen']; ?> " width="200"> </td>                              
                               <td>
