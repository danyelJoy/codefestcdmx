<?php
    ...
    //Camisas y etiquetas
    if(isset($_POST['pedido_extra']['camisas']['cantidad'])){$camisas = $_POST['pedido_extra']['camisas']['cantidad'];}
    if(isset($_POST['pedido_extra']['etiquetas']['cantidad'])) {$etiquetas = $_POST['pedido_extra']['etiquetas']['cantidad'];}
    ...
    if(isset($_POST['registro_evento'])){$eventos = $_POST['registro_evento'];}
    $registro_eventos = eventos_json($eventos);
    if(isset($_POST['fecha_registro'])){$fecha_registro = $_POST['fecha_registro'];}
